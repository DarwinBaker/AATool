...
namespace AATool.Data.Speedrunning
{
    public class Run
    {
        ...
        public Run(TimeSpan inGameTime, TimeSpan realTime, DateTime date, 
        ...
        public static bool TryParse(LeaderboardSheet sheet, int rowIndex, out Run pb)
        {
            pb = null;
            try
            {   
                ...
                pb = new Run(igt, rta, date, runner, verifiable, status, comment, null, blocks);
                return true;
            }
            catch
            {
